      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              href="/dashboard"
              className="text-white/70 hover:text-white px-4 py-2 transition-all duration-300
            ...
            <SignedOut>
              <div className="flex items-center">
                ...
                >
                  <span
                    className="absolute inset-0 rounded-full bg-gradient-to-r from-[#FF1E56] via-[#FF00FF]
                                                    to-[#00FFFF] opacity-70 blur-sm transition-all group-hover:opacity-100"
                  ></span>
